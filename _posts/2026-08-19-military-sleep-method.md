...
先述の通り、6週間訓練を積んだパイロットはコーヒーを飲んだ状態でも2分以内に眠れたらしいが、自分はコーラ1杯に完敗した。さすがに訓練を積んだパイロットには勝てなかったということで、ここは素直に諦めることにした。
...
- 米軍式入眠法：腕→脚→背中・お腹・肩→目→舌→顎の順に全身の力を抜き、最後に湖に浮かぶ小舟をイメージする
